...
run();
/*Ejecutando la conexión básica:
Conectado a la base de datos MySQL (conexión básica)!
Resultados de la consulta (Conexión básica): [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com' },
    { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com' },     
    { id: 3, name: 'Alice Johnson', email: 'alice.johnson@example.com' }
]
Tiempo de ejecución: 38.79 ms
Ejecutando la conexión utilizando promesas:
Conectado a MySQL usando promesas
Resultados de la consulta (Promesas): [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com' },
    { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com' },
    { id: 3, name: 'Alice Johnson', email: 'alice.johnson@example.com' }
]
Tiempo de ejecución: 6.90 ms
Ejecutando la conexión utilizando pooling:
Resultados de la consulta (Pooling): [
    { id: 1, name: 'John Doe', email: 'john.doe@example.com' },
    { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com' },
    { id: 3, name: 'Alice Johnson', email: 'alice.johnson@example.com' }
]
Tiempo de ejecución: 6.28 ms
*/